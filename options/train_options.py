...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--netD', type=str, default='multiscale', help='(n_layer|multiscale|image)')
        parser.add_argument('--netD_uncond', type=str, default='Multiscaleuncond', help='(n_layer|multiscale|image|Multiscaleuncond)')
